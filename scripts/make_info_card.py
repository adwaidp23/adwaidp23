...
# ===========================================================================
HOST = "Adwaidp23"   # shown as  you@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "MCA Student & Data Science Enthusiast"),
    ("kv", "Focus", "Data Analytics, Machine Learning"),
    ("kv", "Portfolio", "adwaidp23.github.io"),
    ("kv", "Edu", "MCA"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Python, SQL, HTML, CSS, JS"),
    ("kv", "AI / ML", "Pandas, NumPy, Scikit-learn"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Building predictive models & analytics dashboards"),
    ("bul", "Transforming raw data into actionable intelligence"),
]
